...
const SecurityPage = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h2 className="text-3xl font-bold text-white mb-2">Paramètres de Sécurité</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h3 className="text-xl font-semibold text-white">Session & Connexion</h3>
              <p className="text-sm text-dark-400">Gestion des sessions utilisateurs</p>
            </div>
          </div>
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h3 className="text-xl font-semibold text-white">Politique de Mot de Passe</h3>
              <p className="text-sm text-dark-400">Règles de complexité</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <p className="text-sm font-medium text-dark-300">Exigences de caractères</p>
              ...
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  ...
                  className="w-5 h-5 rounded border-dark-600 bg-dark-700 text-primary-500 focus:ring-primary-500 focus:ring-offset-dark-800"
                />
                <span className="text-dark-300">Au moins une majuscule (A-Z)</span>
              </label>
              ...
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  ...
                  className="w-5 h-5 rounded border-dark-600 bg-dark-700 text-primary-500 focus:ring-primary-500 focus:ring-offset-dark-800"
                />
                <span className="text-dark-300">Au moins une minuscule (a-z)</span>
              </label>
              ...
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  ...
                  className="w-5 h-5 rounded border-dark-600 bg-dark-700 text-primary-500 focus:ring-primary-500 focus:ring-offset-dark-800"
                />
                <span className="text-dark-300">Au moins un chiffre (0-9)</span>
              </label>
              ...
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  ...
                  className="w-5 h-5 rounded border-dark-600 bg-dark-700 text-primary-500 focus:ring-primary-500 focus:ring-offset-dark-800"
                />
                <span className="text-dark-300">Au moins un caractère spécial (!@#$%)</span>
              </label>
            </div>
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h3 className="text-xl font-semibold text-white">Tokens JWT</h3>
              <p className="text-sm text-dark-400">Durée de validité des tokens</p>
            </div>
          </div>
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h3 className="text-xl font-semibold text-white">Fonctionnalités Avancées</h3>
              <p className="text-sm text-dark-400">Sécurité supplémentaire</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <label className="flex items-center justify-between p-4 bg-dark-800 rounded-lg cursor-pointer hover:bg-dark-700 transition">
              <div>
                ...
                <p className="text-sm text-dark-400 mt-1">Activer 2FA pour tous les utilisateurs (futur)</p>
              </div>
              <div className="relative">
                ...
                <div className={`block w-12 h-6 rounded-full transition ${
                  settings.enable_two_factor ? 'bg-primary-500' : 'bg-dark-600'
                }`}></div>
